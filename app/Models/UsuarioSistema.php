...
class UsuarioSistema extends Authenticatable
{
    ...
    protected $fillable = [
        'id', 'nom', 'ape', 'cor', 'con', 'tel',
        'doc', 'tip_doc', 'fec_nac', 'dir',
        'ciu', 'dep', 'gen', 'rol', 'est',
        'cor_ver', 'cor_ver_en', 'ult_acc', 'not', 'remember_token'
    ];
    ...
    // Relaciones simplificadas - solo para compatibilidad
    ...
    // Métodos simplificados - solo validación de tipo de usuario
    ...
    public function puedeAccederA($recurso)
    {
        ...
        switch ($this->TipoUsuario) {
            ...
            case 'administrador':
                return in_array($recurso, ['usuarios', 'veedurias', 'donaciones', 'tareas', 'archivos']);
            case 'operador':
